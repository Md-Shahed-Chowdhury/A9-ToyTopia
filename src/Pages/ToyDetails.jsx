    ...
    <div className="bg-base-200">
      ...
      <div className="flex flex-col lg:flex-row  p-10 gap-5">
        ...
        <div>
          ...
          <p className="py-2">
            <span className="font-semibold text-lg text-rose-800">
              Category:
            </span>{" "}
            {toy.subCategory}
          </p>
          ...
          <p className="py-2">
            <span className="font-semibold text-lg text-rose-800">Price:</span>{" "}
            {toy.price}
          </p>
          <p className="py-2">
            <span className="font-semibold text-lg text-rose-800">
          ...
          <p className="py-2">
            <span className="font-semibold text-lg text-rose-800">Seller:</span>{" "}
            {toy.sellerName}
          </p>
          <p className="py-2">
            <span className="font-semibold text-lg text-rose-800">
